...
const int GAMEIDX_TO_SCENEIDX[] =
{
	...
	SCENE_FLAPPYBIRD,	//对应GAME_FLAPPYBIRD
	SCENE_TETRIS2,		//对应GAME_TETRIS2
	SCENE_PINBALL2,		//对应GAME_PINBALL2
	SCENE_HITBRICK,		//对应GAME_HITBRICK
	SCENE_ADDBRICK,		//对应GAME_ADDBRICK
};
