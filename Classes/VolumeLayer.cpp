...
void CVolumeLayer::__CreateUI()
{
	...
	// Bakcground
	m_pBGSprite = CREATE_SPRITEWITHNAME(CGlobalFunc::GetSpriteNameWithMode("volumebg.png"));
	...
	m_pCloseMenuItem = MenuItemSprite::create(
		...
		CREATE_SPRITEWITHNAME(strCloseSprName),
		CC_CALLBACK_1(CVolumeLayer::__OnButtonEvent, this));

	// Menu
	m_pMenu = Menu::create(m_pCloseMenuItem, nullptr);
	...
	m_pBGMSlider->addTargetWithActionForControlEvents(this, cccontrol_selector(CVolumeLayer::__OnSliderValueChanged), Control::EventType::VALUE_CHANGED);
	...
	m_pEffectSlider->addTargetWithActionForControlEvents(this, cccontrol_selector(CVolumeLayer::__OnSliderValueChanged), Control::EventType::VALUE_CHANGED);
...
void CVolumeLayer::__OnSliderValueChanged(Ref* pSender, Control::EventType enEvent)
{
...
void CVolumeLayer::__OnButtonEvent(Ref* pSender)
{
	removeFromParent();
}
